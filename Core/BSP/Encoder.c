...
volatile float pwm_v_s = 0;        // 计算出来的实际占空比小齿轮电机
...
// {
//     // 直接读取引脚电平，返回直观的1/0
//     return (HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_10) == GPIO_PIN_SET) ? 1 : 0;
// }


// //方向判断
// void re_direction(void) {
//     level1 = GPIO_Check_Level(GPIOE, GPIO_PIN_10);
//     if(level1 == 1)
//     {
//         // 高电平逻辑
//         Serial_Printf("direction:%d\r\n",level1);
//     }
//     else
//     {
//         // 低电平逻辑
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim) {
    if (htim->Instance == TIM3) {
       ...
       // angular_v_min = cps * 6.28319f;
        ...
        pwm_v_s=rotate_v_s/308*75;//计算出来的转速/最大转速*75占空比//12v给驱动，电机最大是9v，所以75占空比对应9v

        pulse_cnt = 0;  // 清零，准备下一个50ms
    }
